...
typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{#bd93f9}╭─%f '
typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{#bd93f9}├─%f '
typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{#bd93f9}╰─%f %F{#50fa7b}❯%f '
...
typeset -g POWERLEVEL9K_PYTHON_VERSION_PREFIX=' 🐍 '
...
typeset -g POWERLEVEL9K_LOAD_PREFIX=' 💻 '
...
typeset -g POWERLEVEL9K_VCS_REMOTE_BRANCH_ICON='󰘎 '
